...
//	if (document.getElementById("CK" + i).checked) {
		...
		LODOP.ADD_PRINT_TEXT(50, 125, 100, 20, "车主姓名：");
		/*LODOP.SET_PRINT_STYLEA(2, "FontSize", 11);
		LODOP.SET_PRINT_STYLEA(2, "Bold", 1);*/
		
		LODOP.ADD_PRINT_TEXT(50, 215, 100, 20, "单据号：");
		/*LODOP.SET_PRINT_STYLEA(4, "FontSize", 11);
		LODOP.SET_PRINT_STYLEA(4, "Bold", 1);*/
		
		LODOP.ADD_PRINT_TEXT(50, 75, 100, 20, jsonData[0].cplateid);
		LODOP.ADD_PRINT_TEXT(50, 180, 100, 20, jsonData[0].coname);
		LODOP.ADD_PRINT_TEXT(50, 260, 200, 20, jsonData[0].reredocumentid);
		LODOP.ADD_PRINT_TEXT(50, 390, 100, 20, jsonData[0].retimeofreceipt);
		...
		for (i = 1; i < jsonData.length; i++) {
				LODOP.ADD_PRINT_TEXT(iCurLine,15,100,20,jsonData[i].rsname);
				LODOP.ADD_PRINT_TEXT(iCurLine,135,100,20,jsonData[i].rsablemoney);
				LODOP.ADD_PRINT_TEXT(iCurLine,270,100,20,jsonData[i].rsfundsmoney);
				LODOP.ADD_PRINT_TEXT(iCurLine,375,100,20,jsonData[i].rsowemoney);
	...
	//	alert(iCurLine);
		//第三行
		LODOP.ADD_PRINT_TEXT(iCurLine, 15, 100, 20, "小写：");
		/*LODOP.SET_PRINT_STYLEA(9, "FontSize", 11);
		LODOP.SET_PRINT_STYLEA(9, "Bold", 1);*/
		LODOP.ADD_PRINT_TEXT(iCurLine, 265, 100, 20, "大写：");
		/*LODOP.SET_PRINT_STYLEA(10, "FontSize", 11);
		LODOP.SET_PRINT_STYLEA(10, "Bold", 1);*/
//		大小写值
		LODOP.ADD_PRINT_TEXT(iCurLine, 50, 100, 20, sumMoney);
		LODOP.ADD_PRINT_TEXT(iCurLine, 300, 100, 20, convertCurrency(sumMoney));
		
		//收费区间
		LODOP.ADD_PRINT_TEXT(iCurLine+20, 15, 100, 20, "收费区间：");
		/*LODOP.SET_PRINT_STYLEA(11, "FontSize", 11);
		LODOP.SET_PRINT_STYLEA(11, "Bold", 1);*/
//		收费区间值
		LODOP.ADD_PRINT_TEXT(iCurLine+20, 80, 200, 20, shoufei);
		
		/*//第五行
		LODOP.ADD_PRINT_TEXT(iCurLine+50, 90, 100, 20, "备注信息");*/
		
		//第六行
		LODOP.ADD_PRINT_TEXT(iCurLine+35, 15, 100, 20, "制单：");
		/*LODOP.SET_PRINT_STYLEA(13, "FontSize", 11);
		LODOP.SET_PRINT_STYLEA(13, "Bold", 1);*/
		LODOP.ADD_PRINT_TEXT(iCurLine+35, 135, 100, 20, "会计：");
		/*LODOP.SET_PRINT_STYLEA(14, "FontSize", 11);
		LODOP.SET_PRINT_STYLEA(14, "Bold", 1);*/
		LODOP.ADD_PRINT_TEXT(iCurLine+35, 255, 100, 20, "出纳：");
		/*LODOP.SET_PRINT_STYLEA(15, "FontSize", 11);
		LODOP.SET_PRINT_STYLEA(15, "Bold", 1);*/
		
		//第六行
		LODOP.ADD_PRINT_TEXT(iCurLine+35, 55, 100, 20, jsonData[0].rechamberlain);
		LODOP.ADD_PRINT_TEXT(iCurLine+35, 175, 100, 20,"asd");
		LODOP.ADD_PRINT_TEXT(iCurLine+35, 295, 100, 20,"asd");
...
//		}
//	}
	LODOP.ADD_PRINT_LINE(iCurLine+15, 14, iCurLine+15, 510, 0, 1);
...
function AddTitle() {
	...
	LODOP.ADD_PRINT_TEXT(15, 250, 355, 30, "收款单据");
