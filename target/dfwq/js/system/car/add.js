...
$('#coreputationlevel').datetimepicker({
		format : 'yyyy-mm-dd',
		todayBtn : true,
		language : 'zh-CN',
		autoclose : true,	//选中时间后自动关闭
...
//	日期input默认赋值为当前的日期
	$("#crecordtime").val(getNowDate());
	/*$("#cobirthtime").val(getNowDate());
	$("#coreputationlevel").val(getNowDate());
	$("#copapertime").val(getNowDate());
	$("#cocardendtime").val(getNowDate());*/
	$("#rstarttime").val(getNowDate());
	$("#rcontractstarttime").val(getNowDate());
//	$("#rcontractendtime").val(getNowDate());
//	$("#mbirthtime").val(getNowDate());
//	$("#mpapertime").val(getNowDate());
//	$("#mfirstcertificatetime").val(getNowDate());
//	$("#mcertificatetime").val(getNowDate());
//	$("#mcardendtime").val(getNowDate());
//	$("#ebirthtime1").val(getNowDate());
//	$("#epapertime1").val(getNowDate());
//	$("#efirstcertificatetime1").val(getNowDate());
//	$("#ecertificatetime1").val(getNowDate());
//	$("#ecardendtime1").val(getNowDate());
//	$("#ebirthtime2").val(getNowDate());
//	$("#epapertime2").val(getNowDate());
//	$("#efirstcertificatetime2").val(getNowDate());
//	$("#ecertificatetime2").val(getNowDate());
//	$("#ecardendtime2").val(getNowDate());
	$("#carform").validate({
