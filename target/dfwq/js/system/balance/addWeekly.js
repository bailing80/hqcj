...
//				把收费区间和应收金额修改了
				if (chargeSonData[i].chname == "日租金") {
//					$("#rsowemoney"+i).val(getNextWeek()[0]+"~"+getNextWeek()[1]);
//					alert("钱+++"+$("#rsablemoney").val()+"...."+"#rsowemoney"+i);
//					alert($("#oldrsablemoney").val());
					$("#rsablemoney"+i).val($("#oldrsablemoney").val());
...
//			收款小结
			receiptSon.resummary = $("#resummary").val();
//			alert("收款小结"+receiptSon.resummary);
