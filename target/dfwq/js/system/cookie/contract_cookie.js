...
//		获取新的变更信息
		var carInfo = {
			...
			runinformation : {
				id : $("#newruninformationid").val(),
				rserviceid : $("#newrserviceid").val(),
				rservicenature : $("#newrservicenature").val(),
				rcontractlevel : $("#newrcontractlevel").val(),
				rstarttime : $("#rstarttime").val(),
				rcontractstarttime : $("#newrcontractstarttime").val(),
				rcontractendtime : $("#newrcontractendtime").val(),
				rinsuranceplan : $("#newrinsuranceplan").val(),
				rcompany : $("#newrcompany").val()
		}
		...
		var url = rootPath + '/contract/editAllEntity.shtml';
