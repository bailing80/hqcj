	...
	$("#submission").click(function() {
		...
		*/
		...
		var carInfo = {
			//车辆信息
			/*car : {
				cplateid : $("#cplateid").val(),
				ctype : $("#ctype").val(),
				ctradetype : $("#ctradetype").val(),
				cengineid : $("#cengineid").val(),
				coutputvolume : $("#coutputvolume").val(),
				cframeid : $("#cframeid").val(),
				cpurchaseid : $("#cpurchaseid").val(),
				ccolour : $("#ccolour").val(),
				cbook : $("#cbook").val(),
				crecordtime : $("#crecordtime").val(),
...
//		alert(jsonInfo.carowner.clicence);
		var url = rootPath + '/car/saveEntity.shtml';
