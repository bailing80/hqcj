...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/gk/list.js"></script>
	<div class="m-b-md">
		<form class="form-inline" role="form" id="searchForm"
			...
			<div class="form-group">
				<label class="control-label"> <span
					...
					class="input-medium ui-autocomplete-input" id="gk_XM"
					name="gkFormMap.gk_XM">
			</div>
