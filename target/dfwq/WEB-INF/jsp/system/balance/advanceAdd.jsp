...
<script type="text/javascript" src="${ctx}/js/system/balance/showrs.js">
</script>
<style type="text/css">
.col-sm-3 {
	width: 15%;
		...
		<div class="panel-body">
			<div class="form-group">
				...
				<input type="hidden" readonly="readonly"
						class="form-control checkacc" value="${receipt.reredocumentid}" placeholder=""
						name="receiptFormMap.reredocumentid" id="oldreredocumentid">
				<!-- 应收金额 -->		
				<input type="hidden" readonly="readonly"
						class="form-control checkacc" value="${rsablemoney}" placeholder=""
						name="receiptFormMap.reredocumentid" id="rsablemoney">
						<!-- 收款区间 -->		
						<input type="hidden" readonly="readonly"
						class="form-control checkacc" value="${resummary}" placeholder=""
						name="receiptFormMap.reredocumentid" id="resummary">
						
				<input type="hidden" value="${receipt.cid}" readonly="readonly"
						class="form-control checkacc" placeholder=""
						name="receiptFormMap.reredocumentid" id="cid">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
				  <%-- value="${receipt.rechamberlain}" readonly="readonly" --%>
			...
			<!-- 按钮 -->
				...
				<button type="button" id="addAll" class="btn btn-success btn-s-xs" style="float:right;margin-right:67px;">提交</button>
