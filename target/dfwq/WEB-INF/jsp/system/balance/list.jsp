...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/system/balance/list.js"></script>
<div class="m-b-md">
...
//周结的查询
	...
	function paymentMonthly(obj) {
		...
		pageii = layer.open({
			...
			type : 2,
			area : [ "940px", "85%" ],
			content : rootPath + '/balance/payMonthlyMoney.shtml?id=' + id+
			"&rsablemoney="+rsablemoney+"&coname="+coname+"&cplateid="+cplateid+
			"&resummary="+resummary
		});
	}
