					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea type="text" class="form-control checkacc"
								...
								value="${runinformation.rservicenature}" style="width: 65%; resize: none"></textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea type="text" class="form-control" placeholder="请输入合约级别"
								...
								value="${runinformation.rcontractlevel}" style="width: 65%; resize: none"></textarea>
						</div>
					</div>
			<!-- 新加的  -->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea type="text" class="form-control" placeholder="保险方案"
								...
								value="${runinformation.rinsuranceplan}" style="width: 65%; resize: none"></textarea>
						</div>
					</div>
