...
<script type="text/javascript"
	src="${ctx}/js/system/equipment/addEquipmentOut.js">
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/equipment/outAddEntity.shtml">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				<label class="col-sm-3 control-label">出库编号</label>
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc"
						readonly="readonly" name="equipmentoutFormMap.eonumbers"
						id="eonumbers">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control checkacc"
						placeholder="请输入客户名称" name="equipmentoutFormMap.ecustomername"
						id="ecustomername">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入出库人"
						name="equipmentoutFormMap.eooutpeople" id="eooutpeople">
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<fmt:formatDate value="${now}" type="both" dateStyle="long"
						pattern="yyyy-MM-dd" var="currentdate" />
					<input type="text" class="form-control" value="${currentdate}"
						placeholder="请输入出库时间" name="equipmentoutFormMap.eoouttime"
						id="eoouttime">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入部门"
						name="equipmentoutFormMap.eodepartment" id="eodepartment">
				</div>
			</div>
