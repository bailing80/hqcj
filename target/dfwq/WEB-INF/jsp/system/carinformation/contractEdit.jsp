		...
		<div class="tab-pane fade in active" id="caronwer">
			...
			<form id="form" name="form" class="form-horizontal" method="post"
				...
				<input type="hidden" class="form-control checkacc"
					value="${contract.id}" name="carownerFormMap.id" id="carownerid">
							...
							<div class="form-group col-sm-6" hidden>
								...
								<div class="row">
									<input type="text" class="form-control checkacc"
										value="${contract.cplateid}" readonly="readonly"
...
<!-- 							<div class="row">
								<input type="file" readonly="readonly" name="carFormMap.cphoto"
									id="cphoto">
							</div> -->
						</div>
					</div>
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control"
									value="${contract.clicence}" readonly="readonly"
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" readonly="readonly"
									...
									value="${contract.coreputationlevel}">
							</div>
						</div>
					...
					<div class="" style="float: left; margin-left: 50px">
						<textarea class="form-control checkacc" readonly="readonly"
							...
							style="width: 729px; resize: none">${contract.coremark}</textarea>
					</div>
				...
				<div class="panel-body" style="padding: 30px 0px 0px 200px;">
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control checkacc"
								readonly="readonly"
								name="guaranteeFormMap.gname" id="gname"
								value="${contract.gname}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control checkacc"
								readonly="readonly" name="guaranteeFormMap.gidcard" id="gidcard"
								value="${contract.gidcard}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" readonly="readonly"
								name="guaranteeFormMap.gsex" id="gsex" value="${contract.gsex}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control checkacc"
								...
								id="gaddress" value="${contract.gaddress}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea type="text" class="form-control checkacc"
								...
								style="width: 65%; resize: none">${contract.gremark}</textarea>
						</div>
					</div>
				</div>
				</section>
		...
		<div class="tab-pane fade" id="runinformation">
			...
			<form id="form" name="form" class="form-horizontal" method="post"
				...
				<input type="hidden" class="form-control checkacc"
					value="${contract.id}" name="runinformationFormMap.id"
					id="runinformationid">
				<section class="panel panel-default">
				<div class="panel-body panel--padding"
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control checkacc"
								...
								id="rserviceid" value="${contract.rserviceid}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea type="text" class="form-control checkacc"
								readonly="readonly" name="runinformationFormMap.rservicenature"
								id="rservicenature"
								style="width: 65%; resize: none">${contract.rservicenature}</textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea type="text" class="form-control" readonly="readonly"
								...
								style="width: 65%; resize: none">${contract.rcontractlevel}</textarea>
						</div>
					</div>
					<!-- 新加的  -->
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" value="${contract.rcontractstarttime}"   
								class="form-control" readonly="readonly"
								name="runinformationFormMap.rstarttime" id="rstarttime"></input>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" readonly="readonly"
								...
								id="rcontractendtime" value="${contract.rcontractendtime}">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea type="text" class="form-control" readonly="readonly"
								...
								style="width: 65%; resize: none">${contract.rinsuranceplan}</textarea>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea type="text" class="form-control" readonly="readonly"
								...
								style="width: 65%; resize: none">${contract.rremark}</textarea>
						</div>
					</div>
		...
		<div class="tab-pane fade" id="mojorworks">
			...
			<form id="form" name="form" class="form-horizontal" method="post"
				...
				<input type="hidden" class="form-control checkacc"
					value="${contract.id}" name="mojorworksFormMap.id"
					id="majorworksid">
				<section class="panel panel-default">
				<div class="panel-body panel--padding">
					<!-- 第一行 -->
					<div class="row" style="">
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" readonly="readonly"
									value="${contract.msex}" name="mojorworksFormMap.msex"
									id="msex">
							</div>
						</div>
					...
					<div class="row" style="">
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" readonly="readonly"
									value="${contract.midcard}" name="mojorworksFormMap.midcard"
									id="midcard">
							</div>
						</div>
					...
					<div class="row" style="">
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" readonly="readonly"
									value="${contract.mcartype}" name="mojorworksFormMap.mcartype"
									id="mcartype">
							</div>
						</div>
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" readonly="readonly"
									...
									value="${contract.mpapertime}" id="mpapertime">
							</div>
						</div>
					...
					<div class="row" style="">
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" readonly="readonly"
									value="${contract.mcardid}" name="mojorworksFormMap.mcardid"
									id="mcardid">
							</div>
						</div>
					...
					<div class="row" style="">
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" readonly="readonly"
									value="${contract.mfirstcertificatetime}"
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" readonly="readonly"
									value="${contract.mcertificatetime}"
				...
				<div class="panel-body container-fluid panel--padding">
					...
					<div class="row" style="">
						<div class="form-group col-sm-6" hidden>
							...
							<div class="row">
								<input type="hidden" class="form-control checkacc"
									readonly="readonly" value="${employee1.cid}"
									name="employeeFormMap.cid" id="cid1">
							</div>
						</div>
					...
					<div class="row" style="">
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" readonly="readonly"
									value="${employee1.etel}" name="employeeFormMap.etel"
									id="etel1">
							</div>
						</div>
				...
				<div class="panel-body container-fluid panel--padding">
					...
					<div class="row" style="">
						<div class="form-group col-sm-6" hidden>
							...
							<div class="row">
								<input type="hidden" value="${employee2.cid}"
									class="form-control checkacc" readonly="readonly"
									name="employeeFormMap.cid" id="cid2">
					...
					<div class="row" style="">
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" readonly="readonly"
									value="${employee2.etel}" name="employeeFormMap.etel"
									id="etel2">
							</div>
						</div>
	...
	<script type="text/javascript">
		onloadurl();
		var cbox = $.cookie("contractid");
		var url = rootPath + '/contract/selectPicown.shtml?id=' + cbox;
