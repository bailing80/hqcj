...
<body style="position: relative;">
	...
	<div id="myTabContent" class="tab-content">
			...
			<form id="carownerform" name="form" class="form-horizontal"
				...
				<div class="panel-body container-fluid panel--padding">
							...
							<div class="row">
								...
								<div class="row">
									<input type="text" class="form-control" placeholder="请输入性别"
										name="carownerFormMap.cosex" id="newcosex">
								</div>
							</div>
							<div class="row">
								<div class="row">
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" placeholder="请输入出生日期"
										name="carownerFormMap.cobirthtime" id="newcobirthtime"
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" placeholder="请输入准驾车型"
										name="carownerFormMap.cocartype" id="newcocartype"
					...
					<div class="row" style="">
						...
						<div class="form-group col-sm-6">
							<div class="row">
								<label class=" control-label">服务卡姓名</label>
							</div>
							<div class="row">
					...
					<div class="row" style="">
						...
						<div class="form-group col-sm-6">
							<div class="row">
								<label class=" control-label">过户时间</label>
							</div>
							<div class="row">
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control"
										...
										id="newcopapertime" value="${carowner.copapertime}">
							</div>
						</div>
						<div class="form-group col-sm-6">
							<div class="row">
					...
					<div class="row" style="">
						<div class="form-group col-sm-12">
							...
							<div class="row">
								<textarea type="text" class="form-control" placeholder="请输入备注" style="resize:none; width:760px;"
				...
				<div class="panel-body container-fluid panel--padding">
							...
							<div class="row sty3">
								...
								<div class="row">
									<input type="text" class="form-control checkacc"
										...
										readonly="readonly" value="${carowner.coname}">
								</div>
							</div>
							<div class="row">
								<div class="row">
							...
							<div class="row">
								...
								<div class="row">
									<input type="text" class="form-control checkacc"
										...
										id="coidcard" readonly="readonly" value="${carowner.coidcard}">
								</div>
							</div>
						</div>
						<!-- 右面 -->
					...
					<div class="row" style="">
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="file" placeholder="请输入照片" value="${carowner.cophoto}
									readonly="readonly"name="carownerFormMap.cophoto" id="cophoto">
							</div>
						</div>
					</div>
					<div class="row" style="">
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control"
										value="${carowner.clicence}" placeholder="请输入驾驶证号" readonly="readonly"
					...
					<div class="row" style="">
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" placeholder="请输入服务卡号" readonly="readonly"
					...
					<div class="row" style="">
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" placeholder="请输入服务卡姓名" readonly="readonly"
						...
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" placeholder="请输入从业证开始时间" readonly="readonly"
					...
					<div class="row" style="">
						<div class="form-group col-sm-6">
							...
							<div class="row">
								<input type="text" class="form-control" placeholder="请输入从业资格证号" readonly="readonly"
						...
						<div class="form-group col-sm-6">
							<div class="row">
								<label class=" control-label">从业截止日期</label>
							</div>
							<div class="row">
								<input type="text" class="form-control"
										placeholder="请输入从业证截止日期" value="${carowner.cocardendtime}" readonly="readonly"
					...
					<div class="row" style="">
						<div class="form-group col-sm-12">
							...
							<div class="row">
								<textarea class="form-control checkacc" placeholder="请输入备注" readonly="readonly"
										name="carFormMap.cremark" id="cocremark" style="width: 758px; resize:none;">${carowner.coremark}</textarea>
							</div>
						</div>
					</div>
				</div>
		...
		<div class="tab-pane fade" id="newguarantee">
			...
			<form id="guaranteeform" name="form" class="form-horizontal"
				...
				<section class="panel panel-default">
				<div class="panel-body" style="padding: 30px 160px 0px 180px;">
					<div class="form-group">
						<label class="col-sm-3 control-label sty2">姓名</label>
						<div class="col-sm-9">
							<input type="text" class="form-control checkacc"
					...
					<div class="form-group">
						<label class="col-sm-3 control-label sty2">性别</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" placeholder="请输入性别"
					...
					<div class="form-group">
						<label class="col-sm-3 control-label sty2">身份证号</label>
						<div class="col-sm-9">
							<input type="text" class="form-control checkacc"
					...
					<div class="form-group">
						<label class="col-sm-3 control-label sty2">手机号</label>
						<div class="col-sm-9">
							<input type="text" class="form-control checkacc"
					...
					<div class="form-group">
						<label class="col-sm-3 control-label sty2">地址</label>
						<div class="col-sm-9">
							<input type="text" class="form-control checkacc"
					...
					<div class="form-group">
						<label class="col-sm-3 control-label sty2">备注</label>
						<div class="col-sm-9">
							<textarea type="text" style="resize:none;" class="form-control checkacc"
								placeholder="请输入备注" name="guaranteeFormMap.gremark"
								id="newgremark"></textarea>
						</div>
					</div>
			...
			<form id="form" name="form" class="form-horizontal" method="post"
				...
				<div class="panel-body" style="padding: 30px 160px 0px 180px;">
					...
					<div class="form-group">
						<label class="col-sm-3 control-label sty2">备注</label>
						<div class="col-sm-9">
							<textarea class="form-control checkacc" placeholder="请输入备注" style="resize:none; width:360px;"
										name="carFormMap.cremark" id="gremark" style="width: 758px;">${guarantee.gremark}</textarea>
						</div>
					</div>
	...
	$("#caronwersubmit").click(function(){
		...
		alert("1."+$("#cplateid").val());
		 $.ajax({
	            type: "post",
	            url: rootPath + '/transfer/picupload.shtml',
	            data: formData,
	            async: false,
