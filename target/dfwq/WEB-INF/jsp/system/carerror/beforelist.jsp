...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/js/system/carerror/beforelist.js"></script>
...
<script type="text/javascript">
	function showDialog(obj) {
		...
		alert(id);
			alert(rootPath + '/carerror/showAllUI.shtml?id=' + id);
		pageii = layer.open({
			title : "编辑",
			type : 2,
			area : [ "900px", "85%" ],
			content : rootPath + '/carerror/showAllUI.shtml?id=' + id
		});
	}
</script>
