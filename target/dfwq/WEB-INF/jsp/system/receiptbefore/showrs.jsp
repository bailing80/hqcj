...
<script type="text/javascript" src="${ctx}/js/system/receiptbefore/showrs.js">
</script>
<style type="text/css">
.col-sm-3 {
	width: 15%;
...
<body>
	...
	<div class="form-horizontal" style="height:640px;">
		<section class="panel panel-default">
		<div class="panel-body">
			<div class="form-group">
				<label class="col-sm-3 control-label">单据号</label>
				<div class="col-sm-9">
					<input type="text" value="${receipt.reredocumentid}" readonly="readonly"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
				<input type="text" value="${receipt.cplateid}" readonly="readonly" id="cplateid" name='receiptFormMap.cplateid' onkeyup="carAutocomplete()"
				  onblur="" class="form-control checkacc"/>
					<!-- <select id="cplateid" name="receiptFormMap.cplateid"
						...
						name="receiptFormMap.cid" id="cid" class="form-control checkacc" />
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" value="${receipt.coname}" readonly="readonly" class="form-control"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" value="${receipt.rechamberlain}" readonly="readonly" class="form-control" placeholder="收款人"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" value="${receipt.retimeofreceipt}" readonly="readonly" class="form-control" placeholder="请输入收款日期"
						name="receiptFormMap.retimeofreceipt" id="retimeofreceipt">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				<label class="col-sm-3 control-label">预收起始时间</label>
				<div class="col-sm-9">
					<input type="text" value="${receipt.restarttime}" readonly="readonly" class="form-control" placeholder="请输入起始日期"
						name="receiptFormMap.restarttime" id="restarttime">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			<div class="form-group">
				<label class="col-sm-3 control-label">预收截止时间</label>
				<div class="col-sm-9">
					<input type="text" value="${receipt.reendtime}" readonly="readonly" class="form-control" placeholder="请输入截止日期"
						name="receiptFormMap.reendtime" id="reendtime">
				</div>
			</div>
			<div class="line line-dashed line-lg pull-in"></div>
			</div>
			...
			<button type="button" id="print" class="btn btn-success btn-s-xs" style="float:right;margin-right:20px;">打印</button>
			<button id="buttonone" class="form-control" style="width:100px; margin-right:10px;float:right;">收费项</button>
