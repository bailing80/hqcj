...
<script type="text/javascript" src="${ctx}/js/system/receiptbefore/add.js">
...
<body>
	...
	<div class="form-horizontal" style="height:610px;">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
				<input type="text" id="cplateid" name='receiptFormMap.cplateid' onkeyup="carAutocomplete()"
			...
			<div class="form-group">
				...
				<div class="col-sm-9">
					<input type="text" class="form-control" placeholder="请输入起始日期"
			...
			<button type="button" id="addAll" class="btn btn-success btn-s-xs" style="float:right;margin-right:20px;">提交</button>
			<button id="" class="form-control" style="width:100px; margin-right:10px;float:right;" >收费项</button>
