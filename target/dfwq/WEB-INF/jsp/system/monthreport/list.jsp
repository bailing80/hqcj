...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/system/monthreport/list.js"></script>
	<%
		Date date = new Date();
...
<!-- 					 <input
					class="input-medium ui-autocomplete-input" id="retimeofreceipt2"
					name="receiptFormMap.retimeofreceipt" value=""> -->
			</div>
