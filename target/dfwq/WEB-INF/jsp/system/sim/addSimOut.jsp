...
<script type="text/javascript" src="${ctx}/js/system/sim/addSimOut.js">
</script>
<style type="text/css">
.col-sm-3 {
	width: 15%;
...
<body>
	...
	<form id="form" name="form" class="form-horizontal" method="post"
		action="${ctx}/sim/outAddEntity.shtml">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control checkacc" readonly="readonly"
								name="simoutFormMap.sonumbers" id="sonumbers">
						</div>
					</div>
					<div class="line line-dashed line-lg pull-in"></div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" placeholder="请输入出库人"
								name="simoutFormMap.sooutpsople" id="sooutpsople">
						</div>
					</div>
				...
				<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" placeholder="请输入部门"
								name="simoutFormMap.sodepartment" id="sodepartment">
						</div>
				</div>
					<div class="line line-dashed line-lg pull-in"></div>
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" placeholder="请输入入库时间"
								name="simoutFormMap.soouttime" id="soouttime">
						</div>
					</div>
